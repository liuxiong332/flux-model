...
// Notice: defaultValues should ONLY contains scalar
// (number, boolean, null, undefined), because this object will shared
// with the same type's other instances.
...
function makeRecord(likeRecord, map, ownerID) {
  ...
  if (Prototype.constructor) {
    record = new Prototype.constructor(map);
  } else {
